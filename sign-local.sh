#!/bin/bash
# Build, sign and install Insync.app for LOCAL development.
#
...
#
# Usage: ./sign-local.sh [/path/to/Insync.app]
set -euo pipefail

IDENTITY="${INSYNC_SIGN_IDENTITY:-Apple Development: erwinzhang7@gmail.com}"
APP_NAME="Insync"
...
if [ "${INSTALL:-1}" = "1" ]; then
  ...
  echo "  1. Settings > Extensions > tick Insync"
